package tv.savageboy74.savagetech.util.xml;
...
public class XMLHelper {
	...
	public static String toNodeValue(Object obj) {
		...
		if (obj instanceof ItemStack) {
			...
			return Item.REGISTRY.getNameForObject(stack.getItem()) + " " + stack.stackSize + " " + stack.getItemDamage() + (stack.hasTagCompound() ? " " + stack.getTagCompound() : "");
